...
export default function Signup() {
  ...
  const [state, formAction, isPending] = useActionState(async (
    ...
    try {
      ...
      if (password.trim().length < 6) return { error: "Password must be at least 6 characters long", payload: formData };
      if (password !== confirmPassword) return { error: "Password do not match", payload: formData }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  defaultValue={state.error && String(state.payload?.get('password'))}
                />
                <button
                  type="button"
